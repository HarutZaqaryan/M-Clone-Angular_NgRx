...
import { getArticleDetailsAction } from '../../../Shared/Feed/Store/actions/getArticleDetails.actions';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, LoadingComponent, ErrorMessageComponent, TagListComponent],
